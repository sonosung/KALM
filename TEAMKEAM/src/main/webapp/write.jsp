        ...
        <form name="writeFrm" method="post" enctype="multipart/form-data" action="../mvcboard/write.do" onsubmit="return validateForm(this);">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="2">
                        <select name="cate" class="btn btn-secondary">
                ...
                <tr>
                    ...
                    <td colspan="2"><input type="text" name="title" style="width: 90%;" /><br></td>
                </tr>
                <tr>
                    <td align="center" class="bg-secondary text-white">행사명</td>
                    <td colspan="2"><input type="text" name="festivalName" style="width: 90%;" /><br></td>
                </tr>
                <tr>
                    <td align="center" class="bg-secondary text-white">메인 이미지</td>
                    <td colspan="2"><input type="file" name="ofile" class="btn btn-secondary" /></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td colspan="2"><input type="text" name="add" style="width: 42%;" /></td>
                </tr>
                <tr>
                    <td align="center" class="bg-secondary text-white">행사 기간</td>
                    <td colspan="2">
                        <input type="date" name="start-date" style="width: 20%;" class="btn btn-secondary" /> - 
                        <input type="date" name="end-date" style="width: 20%;" class="btn btn-secondary" />
                    </td>
                </tr>
                <tr class="masthead bg-secondary">
                    <td colspan="3" align="right">
                        ...
                        <button type="button" class="btn btn-secondary" onclick="location.href='list.jsp';">목록 바로가기</button>
                    </td>
                </tr>
            </table>
        </form>
