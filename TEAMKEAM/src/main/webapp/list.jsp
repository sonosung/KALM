...
<body id="page-top">
    ...
    <section class="page-section">
        <div class="container">
            <h2 class="text-center text-uppercase text-secondary mb-0">축제 공유 게시글 리스트</h2>
            <!-- 검색 폼 -->
            <form method="get">
                        ...
                        <c:otherwise>
                            ...
                            <c:forEach items="${boardLists}" var="row" varStatus="loop">
                                <tr align="center">
                                    ...
                                    <td align="left"><a href="view.do?idx=${row.num}">${row.title}</a></td>
                                    <td>${row.name}</td>
            ...
            <div class="d-flex justify-content-between">
                <!-- 페이징 -->
                <div>
                    <c:forEach begin="1" end="${pageDTO.totalPages}" varStatus="i">
