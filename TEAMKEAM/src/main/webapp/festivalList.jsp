...
<footer class="footer text-center">
    <div class="container">
        <div class="row">
            ...
            <iframe width="500" height="350" src="https://www.youtube.com/embed/gUckM84W89Q" title="어느 것이 더 검색 됐을까?" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
    </div>
</footer>
<!-- Copyright Section-->
